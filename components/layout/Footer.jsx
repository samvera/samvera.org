const navigation = {
  main: [
    { name: "Contact Us", href: "/get-started/contact-us" },
    { name: "Getting Started", href: "/get-started/getting-started" },
    {
      name: "Examples and Demos",
      href: "/repository-solutions/examples-and-demos",
    },
    { name: "FAQ", href: "/the-community/faq" },
    { name: "News and Events", href: "/news-and-events" },
  ],
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/SamveraRepo",
      icon: (props) => (
